...
from my_nas.common import CNNSearchSpace
from my_nas.evaluator.arch_network import ArchEmbedder
from my_nas.utils import DenseGraphOpEdgeFlow_TAGATES
...
class ENASSearchSpace(CNNSearchSpace):
    ...
    def __init__(self, shared_primitives=(
        ...
        super(ENASSearchSpace, self).__init__(
            num_cell_groups=2,
            num_init_nodes=2,
            num_layers=20, cell_layout=None,
            reduce_cell_groups=(1,),
            num_steps=5, num_node_inputs=2,
            concat_op="concat",
            concat_nodes=None,
            loose_end=True,
    ...
    def random_sample(self):
        ...
        """
        return ENASRollout(ENASRollout.random_sample_arch(
...
class ENASFBFlowArchEmbedder(ArchEmbedder):
    ...
    def __init__(self, search_space,
                 ...
                 symmetry_breaking_method=None, # None, "random", "param_zs"
        ...
        for dim in self.gcn_out_dims:
            self.gcns.append(DenseGraphOpEdgeFlow_TAGATES(
                in_dim, dim,
        ...
        for dim in self.backward_gcn_out_dims:
            self.b_gcns.append(DenseGraphOpEdgeFlow_TAGATES(
                in_dim, dim,
                self.op_dim + self.concat_param_zs_as_opemb_dimension \

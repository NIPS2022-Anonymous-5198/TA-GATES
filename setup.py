...
with open(os.path.join(os.path.dirname(__file__), "my_nas", "VERSION")) as f:
...
setup(
    ...
    version=VERSION,
    license="MIT",
    url="https://github.com/walkerning/my_nas",
    author=AUTHOR,
    author_email=EMAIL,
    ...
    entry_points={
        "console_scripts": [
            "mynas=my_nas.main:main",
            "mynas-hw=my_nas.main_hardware:main"
        ]
    },
